...
@section('main')
    <header class="w-full my-3">
        <h1 class="text-2xl font-bold text-white">CAD/MDT and Officer Settings</h1>
        ...
        <form action="{{ route('admin.settings.update') }}" class="divide-y" id="mdeditor" method="POST">
            ...
            <div class="p-3">
                <div class="flex justify-between">
                    ...
                    <div class="ml-3">
                        <select class="!w-28 select-input" id="use_ten_codes" name="use_ten_codes">
            ...
            <div class="p-3">
                <div class="">
                    <div>
                        <p class="text-lg font-semibold">Officer Name Format</p>
                        <p>This forces a consistent format on officer names in the CAD/MDT. Name will be used on Reports as
                            well.</p>
                    </div>
            ...
            <div class="p-3">
                <p class="text-lg font-semibold">Area of Patrol</p>
                <p>Shows up in CAD and API for where your AOP is located.</p>
                <input class="text-input" name="aop_location" type="text"
            ...
            <div class="p-3">
                <div class="flex justify-between">
                    <div>
                        <p class="text-lg font-semibold">Allow Officers To Control Their Own Unit Number</p>
                        <p>This allows members once accepted into a department or added via Discord Department Roles to
                            update their own unit number.</p>
                    </div>

                    <div class="ml-3">
                        <select class="!w-28 select-input" id="allow_members_to_update_number"
            ...
            <div class="p-3">
                <div class="flex justify-between">
                    <div>
                        <p class="text-lg font-semibold">Allow officers to Control Their Own Department Rank</p>
                        <p>This allows members once accepted into a department or added via Discord Department Roles to
                            update their own department rank. This doesn't affect any roles or permission in the CAD.</p>
                    </div>

                    <div class="ml-3">
                        <select class="!w-28 select-input" id="allow_members_to_update_rank"
            ...
            <div class="p-3">
                <div class="flex justify-between">
                    <div>
                        <p class="text-lg font-semibold">Roleplay Suspended</p>
                        <p>This will show a banner that RP is suspended in the MDT and Civilian portal.</p>
                    </div>

                    <div class="ml-3">
                        <select class="!w-28 select-input" id="roleplay_suspended" name="roleplay_suspended">
