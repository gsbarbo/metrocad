...
@section('main')
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mt-2">
                ...
                @forelse ($announcements as $announcement)
                    <div class="bg-navbar p-2 rounded-lg flex">
                        <img alt="" class="w-16 h-16" onerror="defaultImage('logo')"
                             src="{{ get_setting('community.logo') }}">
                        <div class="ml-4">
            ...
            <div class="space-y-3">
                ...
                <div class="border-navbar border-4 p-2 rounded-lg">
                    <h3 class="text-2xl">{{$newMembers}}</h3>
                    <p class="text-xs">New Members (Last 30 days)</p>
                </div>

                <div class="border-navbar border-4 p-2 rounded-lg">
                    <h3 class="text-2xl">{{$activeMembers}}/{{$allMembers}}</h3>
                    <p class="text-xs">Active/All Members (Logged-in last 5 days)</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 mt-2">
            <a class="border-navbar hover:bg-navbar border-4 p-2 rounded-lg text-center"
            ...
            <a class="border-navbar hover:bg-navbar border-4 p-2 rounded-lg text-center" href="{{route('mdt.home')}}">
                <svg class="h-12 w-12 md:h-16 md:w-16 mx-auto" fill="none" stroke-width="1.5" stroke="currentColor"
                     viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"
            ...
            <a class="border-navbar hover:bg-navbar border-4 p-2 rounded-lg text-center"
               href="{{route('workbench.home')}}">
                ...
                <p class="text-lg">LEO Workbench</p>
            </a>
