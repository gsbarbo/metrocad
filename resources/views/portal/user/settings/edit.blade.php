...
@section('main')
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mt-2">
            ...
            <div class="space-y-3">
                <h1 class="text-2xl font-thin">Connections</h1>
                ...
                <div class="text-sm ml-4">
                    ...
                    <p>Id: {{ auth()->user()->id }}</p>
                    <p class="flex">Picture: <img alt="Profile Picture" class="h-10 w-10 ml-4 rounded-full"
                ...
                @if (config('services.steam.client_secret'))
                    <div class="text-sm ml-4">
                        ...
                        <a href="{{ route('portal.link.steam') }}">
                            <button class="btn-alternative flex items-center">
                                ...
                                @else
                                    <span class="text-sm">Link Steam Account</span>
                                @endif
