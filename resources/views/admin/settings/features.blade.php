        ...
        <form action="{{ route('admin.settings.update') }}" class="divide-y" id="mdeditor" method="POST">
            ...
            <div class="p-3">
                <div class="flex justify-between">
                    <div>
                        <p class="text-lg font-semibold">LOA Requests</p>
                        <p>This will allow members to submit LOA requests through the user profile page.</p>
                    </div>

                    <div class="ml-3">
                        <select class="!w-28 select-input" id="feature_loa_requests" name="feature_loa_requests">
