...
@section('main')
    <x-breadcrumb pageTitle="CAD/MDT/Officer Settings" route="{{ route('admin.dashboard') }}">
        ...
        <x-breadcrumb-link route="{{ route('admin.settings.mdt') }}">CAD/MDT/Officer Settings</x-breadcrumb-link>
    </x-breadcrumb>
    <div>
                ...
                <div class="flex justify-between">
                    ...
                    <div class="ml-3">
                        <select class="!w-28 form-select-input-dark" id="use_ten_codes" name="use_ten_codes">
                            <option @selected(old('use_ten_codes', get_setting('use_ten_codes')) == false) value="0">
                                Off
                            </option>
                            <option @selected(old('use_ten_codes', get_setting('use_ten_codes')) == true) value="1">On
                            </option>
                        </select>
                    </div>
                </div>
            ...
            <div class="p-3">
                <div class="">
                    <div>
                        ...
                        <p class="form-help-text-dark">This forces a consistent format on officer names in the CAD/MDT.
                            Name
                    ...
                    <div class="">
                        <select class="form-select-input-dark" id="officer_name_format" name="officer_name_format">
                            <option
                                @selected(old('officer_name_format', get_setting('officer_name_format')) == 'F. Last') value="F. Last">
                                F. Last
                            </option>
                            <option
                                @selected(old('officer_name_format', get_setting('officer_name_format')) == 'First Last') value="First Last">
                                First Last
                            </option>
                            <option
                                @selected(old('officer_name_format', get_setting('officer_name_format')) == 'First L.') value="First L.">
                                First L.
                            </option>
                        </select>
                    </div>
                ...
                <div class="flex justify-between">
                    ...
                    <div class="ml-3">
                        <select class="!w-28 form-select-input-dark" id="allow_members_to_update_number"
                            ...
                            <option
                                @selected(old('allow_members_to_update_number', get_setting('allow_members_to_update_number')) == false) value="0">
                                Off
                            </option>
                            <option
                                @selected(old('allow_members_to_update_number', get_setting('allow_members_to_update_number')) == true) value="1">
                                On
                            </option>
                        </select>
                    </div>
            ...
            <div class="p-3">
                <div class="flex justify-between">
                    <div>
                        ...
                        <p class="form-help-text-dark">This allows members once accepted into a department or added via
                            Discord Department Roles to
                            update their own department rank. This doesn't affect any roles or permission in the
                            CAD.</p>
                    </div>
                    ...
                    <div class="ml-3">
                        <select class="!w-28 form-select-input-dark" id="allow_members_to_update_rank"
                            ...
                            <option
                                @selected(old('allow_members_to_update_rank', get_setting('allow_members_to_update_rank')) == false) value="0">
                                Off
                            </option>
                            <option
                                @selected(old('allow_members_to_update_rank', get_setting('allow_members_to_update_rank')) == true) value="1">
                                On
                            </option>
                        </select>
                    </div>
            ...
            <div class="p-3">
                <div class="flex justify-between">
                    <div>
                        ...
                        <p class="form-help-text-dark">This will show a banner that RP is suspended in the MDT and
                            Civilian
                            portal.</p>
                    </div>
                    ...
                    <div class="ml-3">
                        <select class="!w-28 form-select-input-dark" id="roleplay_suspended" name="roleplay_suspended">
                            <option
                                @selected(old('roleplay_suspended', get_setting('roleplay_suspended')) == false) value="0">
                                Off
                            </option>
                            <option
                                @selected(old('roleplay_suspended', get_setting('roleplay_suspended')) == true) value="1">
                                On
                            </option>
                        </select>
                    </div>
