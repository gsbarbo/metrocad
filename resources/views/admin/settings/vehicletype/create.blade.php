...
@section('main')
    ...
    <div class="max-w-3xl mx-auto space-y-4">
        <form action="{{ route('admin.settings.vehicletype.store') }}" class="space-y-4" method="POST">
            @csrf

            <x-forms.input name="type" label="Type" required></x-forms.input>
            <x-forms.input name="make" label="Make" required></x-forms.input>
            <x-forms.input name="model" label="Model" required></x-forms.input>
            <x-forms.input name="price" label="Price"></x-forms.input>
            <x-forms.input name="spawn_code" label="Spawn Code"></x-forms.input>
