...
@section('main')
    <header class="w-full my-3">
        ...
        <p class="text-sm">
            <a class="flex text-sm items-center text-blue-600 underline" href="https://communitycad.app/docs/api/get_started"
    ...
    <div class="">
        <div class="py-3">
            <p class="mb-3">If you do not have an API key below you must generate it. This needs to be kept private. You
                can regenerate it any time by clicking on the button below. Only owners can view the API Key.</p>
        </div>
