...
class ActiveUnitResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'civilian' => $this->whenLoaded('civilian') ? [
                'id' => $this->civilian->id,
                'user_id' => $this->civilian->user_id,
                'first_name' => $this->civilian->first_name,
                'last_name' => $this->civilian->last_name,
                'name' => $this->civilian->name,
                'picture' => $this->civilian->picture,
                'date_of_birth' => $this->civilian->date_of_birth,
                'gender' => $this->civilian->gender,
                'race' => $this->civilian->race,
                'height' => $this->civilian->height,
                'weight' => $this->civilian->weight,
                'postal' => $this->civilian->postal,
                'street' => $this->civilian->street,
                'city' => $this->civilian->city,
                'address_id' => $this->civilian->address_id,
                'occupation' => $this->civilian->occupation,
                'status' => $this->civilian->status,
                'is_active' => $this->civilian->is_active,
                'phone_number' => $this->civilian->phone_number,
                'created_at' => $this->civilian->created_at,
                'updated_at' => $this->civilian->updated_at,
                'deleted_at' => $this->civilian->deleted_at,
                'user_department_id' => $this->civilian->user_department_id,
            ] : null,
            ...
            'user_department' => $this->whenLoaded('user_department') ? [
                ...
                'badge_number' => $this->user_department->badge_number,
                'rank' => $this->user_department->rank,
