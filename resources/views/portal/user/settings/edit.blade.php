                ...
                @if (config('services.steam.client_secret'))
                    <div class="text-sm ml-4">
                        ...
                        <a class="inline-block" href="{{ route('portal.link.steam') }}">
                            <button class="btn btn-gray btn-md btn-rounded btn-with-icon">
                                <svg class="size-6" viewBox="0 0 50 50" x="0px" xmlns="http://www.w3.org/2000/svg"
                                     y="0px">
                                    <path
                        ...
                        @if (!get_setting('features.forceSteamLink') && auth()->user()->steam_id)
                            <a class="inline-block" href="{{ route('portal.link.steam.unlink') }}">
                                <button class="btn btn-red btn-md btn-rounded btn-with-icon">
