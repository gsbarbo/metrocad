<div class="bg-gray-800">
    ...
    <nav class="p-4 space-y-2">
        ...
        <x-sidebar_link :active="request()->is('admin')" :href="route('admin.dashboard')">
            <x-slot:icon>
                <svg class="h-6 w-6 flex-shrink-0" fill="none" stroke-linecap="round"
        ...
        <x-sidebar_link :active="request()->is('admin/settings') || request()->is('admin/settings')"
        ...
        <x-sidebar_link
            :active="request()->is('admin/settings/penal-code') || request()->is('admin/settings/penal-code/*')"
            :href="route('admin.settings.penalCode.index')">
            <x-slot:icon>
