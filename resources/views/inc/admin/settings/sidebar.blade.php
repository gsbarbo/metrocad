<!-- Desktop sidebar -->
<div class="z-20 hidden md:block" x-data="{ isSidebarExpanded: false }">
    <aside :class="isSidebarExpanded ? 'w-72' : 'w-20'" @mouseout="isSidebarExpanded = false"
        @mouseover="isSidebarExpanded = true"
        class="flex flex-col text-gray-300 bg-gray-800 transition-all duration-300 ease-in-out h-screen">
        <x-admin.settings.sidebar-links></x-admin.settings.sidebar-links>
    </aside>
</div>
...
<aside @click.away="isSidebarExpanded = false"
    class="fixed inset-y-0 z-20 flex-shrink-0 w-72 mt-16 overflow-y-auto bg-gray-800 md:hidden scrollbar-hide"
    ...
    <x-admin.settings.sidebar-links />
