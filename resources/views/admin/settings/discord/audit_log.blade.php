            ...
            <div class="p-3 flex justify-between">
                ...
                <div class="ml-3">
                    <select class="w-28 select-input" id="feature_use_discord_audit_log"
                        ...
                        <option @selected(old('feature_use_discord_audit_log', get_setting('feature_use_discord_audit_log')) == false) value="off">Off</option>
                        <option @selected(old('feature_use_discord_audit_log', get_setting('feature_use_discord_audit_log')) == true) value="on">On</option>
                    </select>
                </div>
            </div>
