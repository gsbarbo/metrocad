...
{{--                        @if ($nature_filter)--}}
                ...
                <tr class="text-green-600">
                    ...
                    <td class="p-1 border border-slate-400">LEO</td>
                    <td class="p-1 border border-slate-400">DIST - Disturbance
                    </td>
                    <td class="p-1 border border-slate-400">Test</td>
                    <td class="p-1 border border-slate-400">Test</td>
                    <td class="relative p-1 border border-slate-400" x-data="{ statusOpen: false }">
                        ...
                        <div @click.outside="statusOpen = false"
                            ...
                            <a @click="statusOpen = false" class="block hover:bg-gray-500" href="#"
                               wire:click="set_call_priority(0, '1')">1</a>
                            <a @click="statusOpen = false" class="block hover:bg-gray-500" href="#"
                               wire:click="set_call_priority(0, '2')">2</a>
                            <a @click="statusOpen = false" class="block hover:bg-gray-500" href="#"
                               wire:click="set_call_priority(0, '3')">3</a>
                            <a @click="statusOpen = false" class="block hover:bg-gray-500" href="#"
                               wire:click="set_call_priority(0, '4')">4</a>
                            <a @click="statusOpen = false" class="block hover:bg-gray-500" href="#"
                               wire:click="set_call_priority(0, '5')">5</a>
                        </div>
                    </td>
                    <td class="relative p-1 border border-slate-400" x-data="{ statusOpen: false }">
                        <div class="flex justify-between">
                            <span>RCVD - CALL OPEN</span>
                            <a @click="statusOpen = !statusOpen" class="underline cursor-pointer">
                                <svg class="w-6 h-6 text-white" fill="none" stroke-width="1.5" stroke="currentColor"
                                     viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <td class="p-1 border border-slate-400">14m</td>
