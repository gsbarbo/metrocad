    ...
    <section class="h-screen flex flex-col justify-center items-center" x-data="{ modalOpen: true }">
        <div
            ...
            <div class="w-full max-w-[570px] rounded-[20px] bg-gray-400 py-10 px-6 md:py-[40px] md:px-[50px]">
                ...
                <p class="mb-5 leading-relaxed text-justify">
                    Users of this system are advised they are accessing a restricted information system that is governed
                    by
                    applicable agency policies, local laws, state laws, federal laws, and other regulations. Usage may
                    be
                ...
                <div class="flex flex-wrap -mx-3 text-center">
                    <div class="w-1/2 px-3">
                        <a @click="modalOpen = false" class="btn btn-lg btn-green btn-rounded" href="#">
                            Accept and Continue
                        </a>
                    </div>
                    <div class="w-1/2 px-3">
                        <a class="btn btn-lg btn-red btn-rounded" href="{{ route('portal.dashboard') }}">
                            Decline and Exit
                        </a>
                    </div>
                </div>
        ...
        <div
            ...
            <div class="w-full max-w-5xl rounded-[20px] bg-gray-400 py-10 px-6 md:py-[40px] md:px-[50px]">
                ...
                <main class="my-5">
                    <form action="{{ route('mdt.onDuty') }}" class="mx-auto space-y-3" method="POST">
                        @csrf
                        ...
                        <div class="w-full">
                            <button class="btn btn-green btn-lg btn-rounded uppercase">Access System</button>
                        </div>
                    </form>
                </main>
