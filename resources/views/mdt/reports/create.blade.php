...
@section('content')
    <div class="p-2 flex justify-between bg-slate-700 ">
        <div class="text-white">
            <h1 class="text-3xl font-thin">Incident Report - New</h1>
            <h3 class="text-sm">
                <span>Call:</span> 2025003 - Robbery In Progress
                <span>Owner:</span> Rosa Diaz, Ivan
            </h3>
        </div>
        ...
        <div class="col-span-4 space-y-4">
            <div class="bg-slate-700 rounded-lg">
                ...
                <div class="px-5 py-2 space-y-2">
                    <x-forms.input name="" label="Event Location" placeholder="1234 Main St" required mdt readonly/>
                    <x-forms.input name="" label="Event Date" placeholder="09/10/2025" required mdt readonly/>
                    <x-forms.input name="" label="Reporter" placeholder="Rosa Diaz, Ivan" required mdt readonly/>

                    <div class="bg-slate-600 text-white border-b-4 border-slate-800 p-2">
                        <h1 class="ml-5">Report Taken Location</h1>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <x-forms.input name="" label="Postal" placeholder="1234" required mdt/>
                        <x-forms.input name="" label="Street" placeholder="Main Street" required mdt/>
                        <x-forms.input name="" label="City" placeholder="Sandy Shores" required mdt/>
                    </div>
                </div>
            </div>
