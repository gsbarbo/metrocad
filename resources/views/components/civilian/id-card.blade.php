<div class="">
    <div class="bg-gray-300 text-black rounded-lg text-sm border border-yellow-600">
        <div class="rounded-t-lg px-1 flex justify-between items-center text-white bg-yellow-600">
            <p class="text-lg font-bold">{{ strtoupper(get_setting('state')) }}</p>
            <p class="text-sm">ID CARD</p>
        </div>
