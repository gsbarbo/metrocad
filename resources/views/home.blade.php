...
@section('main')
    <div class="max-w-sm mx-auto">
        ...
        <div class="border border-gray-600 mt-8" x-data="{ tab: 'discord' }">
            ...
            <div x-show="tab === 'password'" class="p-2">
                <p class="text-gray-400 pb-2">This is only for tablet login from in-game.</p>

                <x-forms.input name="email" type="email" placeholder="Enter your email" />
                <x-forms.input name="password" type="password" placeholder="Enter your password" />
                <input class="btn btn-green btn-md btn-rounded w-full mt-4" type="submit" value="Login">
            </div>
        </div>
    </div>
@endsection
