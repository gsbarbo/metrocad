<div class="bg-sidebar">
    <!-- Desktop sidebar -->
    <div class="z-10 flex-shrink-0 hidden md:block overflow-y-auto scrollbar-hide" x-data="{ isSidebarExpanded: false }">
        <aside :class="isSidebarExpanded ? 'w-64' : 'w-20'" @mouseout="isSidebarExpanded = false"
            ...
            <x-portal.sidebar-links></x-portal.sidebar-links>
        </aside>
    </div>
